#include "blowWall.hpp"
#include <utilities/mathUtilities.hpp>
#include "finiteVolume/compressibleFlowFields.hpp"

void ablate::boundarySolver::physics::BlowWall::Setup(ablate::boundarySolver::BoundarySolver &bSolver) {
...
PetscErrorCode ablate::boundarySolver::physics::BlowWall::UpdateBoundaryVel(PetscInt dim, const ablate::boundarySolver::BoundarySolver::BoundaryFVFaceGeom *fg,
    ...
    PetscReal logLawVel[3] = {0.0, 0.0, 0.0};
    ...
    } else if (dim == 3) {  // for 3D
        //  Map tangential velocities into the flow direction such that there is one velocity vector
        PetscReal TINY = 1e-20;
        theta = atan(stencilNormalVelocity[2] / (stencilNormalVelocity[1] +TINY));
...
REGISTER_WITHOUT_ARGUMENTS(ablate::boundarySolver::BoundaryProcess, ablate::boundarySolver::physics::BlowWall,
